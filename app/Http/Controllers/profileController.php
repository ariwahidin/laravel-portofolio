...
class profileController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            '_foto.mimes' => 'Format foto tidak valid',
        ...
        if ($request->hasFile('_foto')) {
            ...
            // Kalau ada update foto, foto lama dihapus
        ...
        return redirect()->route('profile.index')->with('success', 'Data profile berhasil disimpan');
    }
}
