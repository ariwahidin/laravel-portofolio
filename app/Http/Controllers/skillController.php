    ...
    public function update(Request $request)
    {
        if ($request->method() == 'POST') {
            $request->validate([
                ...
                '_language.required' => 'Programing Language wajib diisi',
                '_workflow.required' => 'Work flow wajib diisi',
            ]);
            ...
            return redirect()->route('skill.index')->with('success', 'Berhasil edit data skill');
        }
    }
}
